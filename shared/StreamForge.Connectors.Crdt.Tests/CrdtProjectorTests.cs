...
public class CrdtProjectorTests
{
    ...
    public void DiffOpAndWeightLiteralsMatchCdcStampsSpellingExactly()
    {
        ...
        // StreamForge.Connectors.Database.CdcStamp uses... a test should assert the literals rather than
        // trusting the two to stay in step."
        //
        // CrdtProjector deliberately does NOT reference StreamForge.Connectors.Database (see its class
