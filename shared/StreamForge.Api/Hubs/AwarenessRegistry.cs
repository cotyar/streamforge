...
/// <c>StreamForge.AppCore.Ingest.SourceIngressRegistry</c>, which pins the shape a process-lifetime,
...
///
/// <para><b>Per-host, not per-cluster — stated, not discovered.</b> <c>StreamForge.Api</c> registers
