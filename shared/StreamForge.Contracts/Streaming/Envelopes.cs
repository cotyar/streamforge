namespace StreamForge.Abstractions.Streaming;
...
// StreamForge.Engine.EventRecord itself: EventRecord is a Dictionary<string, object?> SUBCLASS, which
// needs a hand-written surrogate to cross Orleans' serializer (see
// StreamForge.Host.Serialization.EventRecordSurrogate) and — more to the point here — Contracts has no
// dependency on StreamForge.Engine (kept minimal per decision D-A). A plain Dictionary carries the
