...
///
/// <para><b>The honest limit, restated for the native path:</b> a StreamForge source is an
...
/// source's history. See <see cref="StreamForge.AppCore.Connectors.Mapping.CdcEnvelope"/>'s own class
/// doc for the longer version of this same limit.</para>
/// </summary>
public static class CdcStamp
{
    /// <summary>The op letter, matching <see cref="StreamForge.AppCore.Connectors.Mapping.CdcEnvelope"/>'s
    ...
    /// deliberately Debezium's OWN literal (<c>__debezium_unavailable_value</c>), not a StreamForge
