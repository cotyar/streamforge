...
namespace StreamsForge.AppCore.Tests.Discovery;
...
/// <c>StreamsForge.Connectors.Database.Tests</c>; <c>NamedEndpointResolutionTests</c> in
/// <c>StreamsForge.Connectors.Fix.Tests</c>) since they live in different assemblies with their own test
...
/// <see cref="PeerDirectory"/>). This file shares xUnit collection <c>"StreamsForge.Discovery.PeerDirectory"</c>
...
[Collection("StreamsForge.Discovery.PeerDirectory")]
