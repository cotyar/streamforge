...
/// nothing newer, can never acknowledge data StreamsForge has not durably recorded. WHERE in the cycle that
...
/// <see cref="StreamsForge.AppCore.Connectors.Mapping.CdcEnvelope"/>'s documented behavior for the same
