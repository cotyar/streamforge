...
/// core in this assembly — <c>StreamsForge.AppCore</c> gains nothing, exactly like
/// <c>StreamsForge.Connectors.Database</c>'s postgres/mssql kinds. It yields the raw SOH-delimited FIX
...
///
/// <para><b><see cref="StreamsForge.AppCore.Transports.InboundMessage.AckAsync"/> is always null.</b>
...
public sealed class FixInboundTransport(Func<IFixMessageSource>? sourceFactory = null) : IInboundTransport
{
    ...
    /// <see cref="StreamsForge.AppCore.Transports.InboundMessage.AckAsync"/> is always null — see this
