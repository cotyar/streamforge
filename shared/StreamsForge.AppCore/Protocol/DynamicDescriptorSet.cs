...
public sealed class DynamicDescriptorSet(ICatalogFacade registry)
{
    public async Task<IReadOnlyList<DynamicEntityDescriptor>> BuildAsync(CancellationToken cancellationToken = default)
    {
        ...
        // Inlined equivalent of StreamsForge.Host.Grpc.SchemaBuilder.BuildStreamSchemasAsync (which is
    ...
    /// <summary>Inlined equivalent of <c>StreamsForge.Host.Grpc.ProtoMappers.MapFieldKind(FieldType)</c> —
