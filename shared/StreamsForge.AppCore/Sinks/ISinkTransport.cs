...
public interface ISinkTransport
{
    ...
    /// config — the sink-side twin of <see cref="StreamsForge.AppCore.Transports.IInboundTransport.Validate"/>
    /// and <see cref="StreamsForge.AppCore.Transports.IPolledTransport.Validate"/>. Never throws; an empty
...
public sealed class NatsSinkTransport : ISinkTransport
{
    ...
    public TransportDescriptor Describe() => new()
    {
        ...
        [
            ...
            new TransportField
            {
                Key = "subject", Label = "Subject", Required = true, Mono = true, Placeholder = "streamsforge.{name}",
