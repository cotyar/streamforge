...
/// something the Engine already computes — but StreamsForge.Engine is FROZEN (read-only) and its public
...
/// <summary>Mirrors the two reserved EventRecord field names (StreamsForge.Engine.EventRecord.TimestampField
