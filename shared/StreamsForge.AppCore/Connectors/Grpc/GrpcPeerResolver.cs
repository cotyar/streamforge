...
/// <see cref="StreamsForge.Abstractions.GrpcSubConfig.Peer"/> is set it WINS over both
/// <see cref="StreamsForge.Abstractions.GrpcSubConfig.Address"/> and
/// <see cref="StreamsForge.Abstractions.GrpcSubConfig.RestAddress"/> outright — it does not merely fill
...
{
    public static ResolvedGrpcEndpoints Resolve(StreamsForge.Abstractions.GrpcSubConfig config)
    {
...
/// <see cref="PeerName"/> is null when <see cref="StreamsForge.Abstractions.GrpcSubConfig.Peer"/> was
