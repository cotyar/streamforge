...
/// one a given install produces is a connector-config decision StreamsForge does not control: the raw
...
///
/// <para><b>The honest limit</b> (stated here, not left for a reader to infer): a StreamsForge source is
...
/// <c>IngressRowAcceptance.RetractField</c> and <see cref="StreamsForge.Engine.Runtime.Ops"/>'s
