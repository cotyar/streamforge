...
/// (<see cref="StreamsForge.Abstractions.FileFormats"/>), each turning raw text into a flat list of
/// <see cref="JsonElement"/> items ready for <see cref="StreamsForge.AppCore.Connectors.Mapping.RecordExtractor"/>.
