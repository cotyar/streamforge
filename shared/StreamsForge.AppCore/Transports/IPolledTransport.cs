...
/// defaulted-parameter shape <see cref="StreamsForge.AppCore.Connectors.PollCycleResult"/> used to solve
...
/// sentence (see their <c>CycleNote</c>), and <see cref="StreamsForge.AppCore.Connectors.PollCycleResult.EnvelopeSkipped"/>
...
/// <c>StreamsForge.Api</c> learning what a database is: it knows a probe returns fields and notes, and
/// nothing further.
///
