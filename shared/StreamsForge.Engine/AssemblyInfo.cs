...
// Grants StreamsForge.Engine.Tests direct access to this assembly's `internal` types — used by plan 003
...
// change PublicApi.cs or grant access to any other assembly (in particular NOT StreamsForge.Host — the
// sibling agent's territory keeps consuming Engine through exactly the same public surface as before).
[assembly: InternalsVisibleTo("StreamsForge.Engine.Tests")]
