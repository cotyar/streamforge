...
/// client-pushed ingest row, and (plan 020) by <c>StreamsForge.Connectors.Crdt.CrdtProjector</c> on the
...
/// (StreamsForge.Api's SourcesEndpoints, backed by AppCore's RetractConsumerValidation) — note that the
