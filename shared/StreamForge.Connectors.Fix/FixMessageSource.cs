...
/// and what <see cref="StreamForge.AppCore.Transports.InboundMessage.Subject"/> means for this transport
...
/// <see cref="StreamForge.AppCore.Connectors.Nats.INatsMessageSource"/>'s role for NATS: everything
...
public sealed class FixBridgeApplication : IApplication
{
    ...
    /// in <c>StreamForge.AppCore</c> and keeps this method private; the two are one line of logic each and
