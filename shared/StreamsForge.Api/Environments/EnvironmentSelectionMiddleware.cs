...
/// entire codebase. Reads <c>X-StreamsForge-Environment</c> (a <c>?env=</c> query parameter overrides it,
...
/// use would make <c>X-StreamsForge-Environment: stagng</c> a successful deploy into a new empty
...
/// exist" (404) from "you are not signed in" (401) by probing <c>X-StreamsForge-Environment</c> values
...
public static class EnvironmentSelectionMiddleware
{
    ...
    public const string HeaderName = "X-StreamsForge-Environment";
