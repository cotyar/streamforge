...
/// StreamsForgeApiExtensions.AddStreamsForgeApi/MapStreamsForgeApi exactly like every other shared
/// endpoint group).
///
...
public static class ChatEndpoints
{
    ...
    private static ChatToolGate BuildGate(GeminiChatService chat, ClaimsPrincipal principal, IServiceProvider services)
    {
        ...
        var logger = services.GetRequiredService<ILoggerFactory>().CreateLogger("StreamsForge.Api.Chat");
