...
/// <c>streamsforge.v1</c>/<c>streamsforge.dynamic.v1</c> (control-plane) descriptors — walked from the
/// generated <c>StreamsforgeReflection.Descriptor</c>/<c>StreamsforgeDynamicReflection.Descriptor</c> and
...
public sealed class DynamicReflectionService(ICatalogFacade catalog) : ServerReflection.ServerReflectionBase
{
        ...
        switch (request.MessageRequestCase)
        {
            ...
            default:
                ...
                response.ErrorResponse = new ErrorResponse
                {
                    ...
                    ErrorMessage = "Not supported by StreamsForge dynamic reflection",
                };
                break;
        }
    ...
    private static IReadOnlyList<FileDescriptor> BuildStaticFiles()
    {
        ...
        AddClosure(StaticV1.StreamsforgeReflection.Descriptor);
        AddClosure(DynamicV1.StreamsforgeDynamicReflection.Descriptor);
