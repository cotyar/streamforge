...
/// <summary>Maps between StreamsForge.Abstractions/Engine model types and the generated
/// StreamsForge.Host.Grpc.V1 proto messages. Kept separate from the service implementations so the
