...
/// orleans/tests/StreamsForge.Host.Tests/SourcesEndpointsLogicTests.cs) — mirrors the
...
public static class SourceValidation
{
    ...
    /// from <c>StreamsForge.Connectors.Database.CdcStamp</c> because this assembly does not depend on that
...
public static class SourceSchemaService
{
    ...
    /// <c>StreamsForge.Host.Grpc.Dynamic.EntitySchemas.ParseMap</c> expects to read it back (plain
