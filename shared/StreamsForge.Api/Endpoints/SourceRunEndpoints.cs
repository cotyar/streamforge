...
/// (shared/StreamsForge.AppCore/Generators/ScenarioGenerator.cs) that
...
/// orleans/src/StreamsForge.Host/Grains/GeneratorGrain.cs; Dapr <c>GeneratorActor.RunAsync</c>,
/// dapr/src/StreamsForge.Dapr.Host/Actors/GeneratorActor.cs) DO publish every generated row the same way a
/// tick would — but this file lives in shared/StreamsForge.Api, which (like every other file in this
...
/// (orleans/src/StreamsForge.Host/Facades/OrleansFacades.cs and its Dapr-Host-Program.cs counterpart —
...
/// (orleans/tests/StreamsForge.Host.Tests/GeneratorGrainScenarioRunTests.cs) — this endpoint is "just" the
