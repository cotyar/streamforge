...
/// (orleans/src/StreamsForge.Host/Facades/OrleansFacades.cs), except this always answers (200 +
...
public static class PlanEndpointsLogic
{
    ...
    /// <param name="flavor"><see cref="StreamsForgeApiOptions.Flavor"/> ("orleans" | "dapr") — partitioned
