...
// contracts side (StreamsForge.Contracts/IngestModels.cs); these are the wire shapes only.
// ============================================================================
...
// CrdtMergeResult/CrdtDocStatus types (StreamsForge.Abstractions) directly — no wrapper DTO, same as
...
/// <see cref="StreamsForge.Engine.Dataflow.TableStageDescriptor"/> (Kind stringified via ToString(), same
...
/// <see cref="StreamsForge.Engine.Dataflow.TableEdgeDescriptor"/>. FromStageId/ToStageId == -1 have the
