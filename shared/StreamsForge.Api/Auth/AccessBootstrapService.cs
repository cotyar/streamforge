...
/// per start.
///
/// <para><b>Why it is registered from <c>AddStreamsForgeApi</c> and not from a host's
/// <c>Program.cs</c>.</b> Both hosts already call <c>AddStreamsForgeApi</c>, so this is the single place
