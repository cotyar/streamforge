...
// sweeper"). Both hosts already run BackgroundServices, and both call AddStreamsForgeApi — so this is
// registered there, and neither Program.cs is touched.
// =================================================================================================

/// <summary>The <c>Approvals:*</c> configuration, read once in <c>AddStreamsForgeApi</c> and passed
