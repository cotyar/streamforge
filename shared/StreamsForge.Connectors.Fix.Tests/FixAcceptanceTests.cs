...
public class FixAcceptanceTests
{
    ...
    ///
    /// <para><b>The same test project is in BOTH solutions</b> (<c>orleans/StreamsForge.sln</c> and
    /// <c>dapr/StreamsForge.Dapr.sln</c>), so running the two suites back to back binds this acceptor twice
