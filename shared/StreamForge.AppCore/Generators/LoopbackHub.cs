...
/// <c>LoopbackSinkClient</c> (shared/StreamForge.AppCore/Sinks/LoopbackSinkClient.cs) WRITES into it via
...
/// <c>StreamForge.AppCore</c> is the runtime-neutral core both Orleans and Dapr depend on (AGENTS.md rule
...
/// silently swallowed. See <c>LoopbackCycleTests</c> (orleans/tests/StreamForge.Host.Tests) for the test
