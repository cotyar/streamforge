...
/// <summary>
/// Plan 018: <see cref="StreamForge.Abstractions.FileFormats.Fix"/> — tag=value FIX protocol text (a
...
/// <see cref="StreamForge.AppCore.Connectors.Mapping.RecordExtractor"/>, and a
