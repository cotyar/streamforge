...
public class LegacyEquivalenceMatrixTests
{
    ...
    [
        ...
        new("rest", "GET /api/sources/{name}/openapi", "Viewer", Actions.SourceRead, "trades"),
        ...
        new("rest", "GET /api/pipelines/{id}/openapi", "Viewer", Actions.PipelineRead, "p1"),
        ...
        new("rest", "GET /api/tables/{id}/openapi", "Viewer", Actions.TableRead, "t1"),
