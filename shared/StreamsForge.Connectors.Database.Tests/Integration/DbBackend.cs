...
internal sealed class PostgresBackend : DbBackend
{
    ...
    public override string Database => "streamsforge";

    public override string AdminDatabase => "streamsforge";

    public override string Username => "streamsforge";

    public override string Password => "streamsforge";
