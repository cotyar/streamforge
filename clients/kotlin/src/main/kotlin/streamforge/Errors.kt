...
sealed class StreamForgeException(message: String, cause: Throwable? = null) : Exception(message, cause)
 ...
 * than looping). */
class AuthException(message: String, cause: Throwable? = null) : StreamForgeException(message, cause)
...
class NotReadyException(message: String) : StreamForgeException(message)
...
class StreamForgeError(message: String, cause: Throwable? = null) : StreamForgeException(message, cause)
...
class SqlException(rawMessage: String, val diagnostics: List<Diagnostic>, val sqlText: String? = null) :
    StreamForgeException(renderSqlMessage(rawMessage, diagnostics, sqlText))
