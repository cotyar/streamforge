...
/**
 * Contract tests against a REAL, isolated StreamForge instance ([EngineFixture]), parametrized
...
class ContractTest {
    ...
    private suspend fun connectVia(transport: Transport): StreamForgeClient {
        val client = StreamForge.connect(
    ...
    private suspend fun waitForSnapshotToContain(sf: StreamForgeClient, table: String, tradeId: String) {
