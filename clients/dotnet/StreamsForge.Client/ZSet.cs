...
/// <summary>Stable content-based identity for rows, ported from clients/python/src/streamsforge/_zset.py's
...
/// <summary>
/// The Z-set reducer -- ported literally from clients/python/src/streamsforge/_zset.py, itself a
/// port of lib/streamsforge/live-table.ts (otc-terms) / web/src/hooks/useTableRows.ts. Pure state,
