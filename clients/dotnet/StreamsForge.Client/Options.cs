...
/// <summary>Which live transport <see cref="StreamsForgeClient.ConnectAsync"/> should use.</summary>
...
/// <summary>
/// Connection options for <see cref="StreamsForgeClient.ConnectAsync"/>. A small record instead of
...
public sealed record ConnectOptions
{
    ...
    /// <c>STREAMSFORGE_BASE_URL</c>.</summary>
    public string? Url { get; init; }

    /// <summary>gRPC target, e.g. <c>localhost:9299</c>. Falls back to <c>STREAMSFORGE_GRPC</c>,
    ...
    /// <summary>Falls back to <c>STREAMSFORGE_ADMIN_USER</c>.</summary>
    public string? User { get; init; }

    /// <summary>Falls back to <c>STREAMSFORGE_ADMIN_PASS</c>.</summary>
    ...
    /// <summary>Preferred over the admin JWT for <see cref="StreamsForgeClient.PushAsync"/> when
