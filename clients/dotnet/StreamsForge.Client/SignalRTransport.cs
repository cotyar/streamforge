...
internal sealed class SignalRTransport : ITransport
{
    ...
    /// <summary>Opens and immediately tears down a connection -- used by <see cref="StreamsForgeClient.ConnectAsync"/>'s
    ...
    /// best-effort one: <c>StreamHub.SubscribeTable</c> (shared/StreamsForge.Api/Hubs/StreamHub.cs)
