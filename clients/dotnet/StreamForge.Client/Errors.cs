...
{
    public StreamForgeException(string message) : base(message) { }
    public StreamForgeException(string message, Exception inner) : base(message, inner) { }
}
...
public sealed class AuthException : StreamForgeException
{
...
public sealed class NotReadyException : StreamForgeException
{
...
public sealed class IngestRejectedException : StreamForgeException
{
...
public sealed class SqlException : StreamForgeException
{
