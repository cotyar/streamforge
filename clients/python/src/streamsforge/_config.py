"""Config resolution: explicit kwargs -> env -> ~/.config/streamsforge/config.toml.
...
CONFIG_PATH = Path.home() / ".config" / "streamsforge" / "config.toml"
...
def resolve(
    *,
    ...
    return ResolvedConfig(
        base_url=pick(url, "STREAMSFORGE_BASE_URL", "base_url"),
        grpc=pick(grpc, "STREAMSFORGE_GRPC", "grpc"),
