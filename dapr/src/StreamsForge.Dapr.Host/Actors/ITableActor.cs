...
/// orleans/src/StreamsForge.Host/Grains/TableGrain.cs's class doc: "Key = table name"). Dapr counterpart of
...
public interface ITableActor : IActor
{
    ...
    /// <see cref="StreamsForge.Engine.SqlCompiler.CompileTable"/>), replacing any previous executor/search
    ...
    /// re-normalizes before handing rows to the Engine — see <c>dapr/tests/StreamsForge.Dapr.Tests/
