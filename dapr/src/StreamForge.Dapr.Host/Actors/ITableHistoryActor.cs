...
/// <c>ITableHistoryGrain</c> (orleans/src/StreamForge.Abstractions/GrainInterfaces.cs) /
/// <c>TableHistoryGrain</c> (orleans/src/StreamForge.Host/Grains/TableHistoryGrain.cs) — read every method
...
public interface ITableHistoryActor : IActor
{
    ...
    /// <c>dapr/tests/StreamForge.Dapr.Tests/TableHistoryApplicationTests.cs</c> for a round-trip test
    ...
    /// (<c>shared/StreamForge.Api/Endpoints/TablesEndpoints.cs</c>'s <c>/history/lookup</c> handler) BEFORE
