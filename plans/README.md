...
| 019 | [FIX order entry: a first-class bidirectional connector](019-fix-order-entry.md) | PLANNED — the fork is CLOSED: option **(b)**, a bidirectional connector as the third transport seam, chosen 2026-08-18; waves A–I sequenced, the cluster-singleton requirement resolved by putting the session in the connector driver | 018 (`fix` format + session project), 010, 014 |
