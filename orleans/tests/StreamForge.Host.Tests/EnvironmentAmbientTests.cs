...
/// <see cref="WebApplication"/> AFTER <see cref="StreamForgeApiExtensions.MapStreamForgeApi"/>, and
...
public sealed class EnvironmentAmbientTests : IAsyncDisposable
{
    ...
    private async Task<HttpClient> StartAsync(FakeEnvironmentFacade environments)
    {
        ...
        // they still go through EnvironmentSelectionMiddleware (registered inside MapStreamForgeApi)
