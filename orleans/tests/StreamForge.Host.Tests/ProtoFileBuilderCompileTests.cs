...
/// Grpc.Tools 2.80.0 / 3.31.1 — the same versions StreamForge.Host itself references transitively via
...
public class ProtoFileBuilderCompileTests
{
    ...
    public void Fattest_schema_shape_plus_streaming_contract_compiles_standalone_with_protoc()
    {
        ...
        try
        {
            ...
            // (tools/generate-client.sh's StreamForgeClient.cs template) depends on.
