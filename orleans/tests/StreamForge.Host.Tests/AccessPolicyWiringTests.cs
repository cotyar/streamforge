...
///
/// <para>Everything here runs against the policies <see cref="StreamForgeApiExtensions.AddStreamForgeApi"/>
...
public class AccessPolicyWiringTests
{
        ...
        params (string Key, string Value)[] settings)
    {
        ...
        // Registered AFTER AddStreamForgeApi, exactly as each host's AddOrleansFacades/AddDaprFacades is
    ...
    {
        // AuthorizationCoverageTests builds a WebApplication and never starts it; AddStreamForgeApi now
