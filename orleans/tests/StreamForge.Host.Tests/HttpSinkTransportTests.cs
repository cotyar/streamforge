...
public class HttpSinkTransportTests
{
    ...
    public void IsRegisteredUnderTheHttpKind()
    {
        ...
        var found = StreamForge.AppCore.Sinks.SinkTransports.Find(SinkKinds.Http);
    ...
    {
        var found = StreamForge.AppCore.Sinks.SinkTransports.Find(kind);
    ...
    public void Active_ExcludesAHalfConfiguredHttpSink()
    {
        ...
        var active = StreamForge.AppCore.Sinks.SinkSelection.Active(sinks);
    ...
    public void Describe_MatchesTheConfigContainerAndCarriesTheMaxDepthField()
    {
        ...
        Assert.Contains(descriptor.Fields, f => f is { Key: "headerValue", Type: StreamForge.AppCore.Transports.TransportFieldTypes.Secret });
    }
