...
public class EntityOpenApiLogicTests
{
    ...
    private static JsonNode AppDocument() => JsonNode.Parse(
        ...
        {
          "openapi": "3.1.1",
          "info": { "title": "StreamForge API", "version": "1.0.0", "description": "whole API" },
          "paths": {
            "/api/tables": { "get": { "tags": ["StreamForge.Host"], "responses": { "200": {} } } },
            "/api/tables/{id}": {
              "get": {
                "tags": ["StreamForge.Host"],
            ...
            "/api/pipelines/{id}": { "get": { "tags": ["StreamForge.Host"], "responses": { "200": {} } } },
            "/api/auth/login": {
              "post": {
                "tags": ["StreamForge.Host"],
                "requestBody": { "content": { "application/json": {
    ...
    private static JsonObject BuildTableDocument(JsonObject? rowSchema = null, string? rowSchemaName = null) =>
        EntityOpenApiLogic.BuildEntityDocument(
            ...
            "StreamForge table \"positions\"", "one table", "positions", rowSchema, rowSchemaName);
    ...
    public void RetitlesAndRetagsSoTheReferenceReadsAsOneEntity()
    {
        ...
        Assert.Equal("StreamForge table \"positions\"", (string?)doc["info"]!["title"]);
