...
/// (<c>StreamsForge.AppCore.Tests/Access</c>). What is NOT covered there, and is exactly what this wave
...
public class PermissionResolverTests
{
    ...
    {
        var denied = new StreamsForge.AppCore.Access.AccessResult(
        ...
        var body = Assert.IsType<StreamsForge.Api.ErrorResponse>(
    ...
    {
        Roles = StreamsForge.AppCore.Access.BuiltInRoleCatalog.Create(),
        Version = version,
    };
