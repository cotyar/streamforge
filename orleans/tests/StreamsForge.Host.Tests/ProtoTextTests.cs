...
public class ProtoTextTests
{
    ...
    public void Flat_schema_renders_exact_golden_proto_text()
    {
        ...
        const string expected =
            ...
            "message Orders {\n" +
            "  string id = 1; // StreamsForge: String\n" +
            "  int64 qty = 2; // StreamsForge: Long\n" +
            "}\n\n" +
            "message OrdersEvent {\n" +
            "  Orders row = 1;\n" +
            "  int64 seq = 2;\n" +
    ...
    public void Struct_field_renders_google_protobuf_struct_type_and_import()
    {
        ...
        Assert.Contains("google.protobuf.Struct meta = 2; // StreamsForge: Json (schemaless)", schema.ProtoText);
    }
