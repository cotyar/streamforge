...
/// — moved to StreamsForge.Abstractions (shared/StreamsForge.Contracts) so both flavors dispatch on the same
...
/// their own hand-written string comparisons). dapr/tests/StreamsForge.Dapr.Tests/IngestKindDispatchTests.cs
