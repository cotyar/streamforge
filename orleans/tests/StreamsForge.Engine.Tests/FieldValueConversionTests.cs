...
/// StreamsForge.AppCore.Ingest.FieldValueCoercion.TryCoerce (FieldType-keyed) and
/// StreamsForge.AppCore.Ingest.RowTimestamp.Resolve — see this type's own doc comment for exactly which
