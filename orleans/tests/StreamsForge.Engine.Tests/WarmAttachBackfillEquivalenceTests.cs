...
/// <c>StreamsForge.Engine.TableExecutor.LastEpoch</c>'s own doc comment in PublicApi.cs) is covered
/// end-to-end by orleans/tests/StreamsForge.Host.Tests/BackfillOnAttachClusterTests.cs; these tests pin the
