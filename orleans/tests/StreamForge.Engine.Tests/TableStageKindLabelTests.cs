...
public class TableStageKindLabelTests
{
    ...
    private static IReadOnlyList<TableStageKind> StageKindsOf(StreamForge.Engine.TableCompileResult compileResult)
    {
    ...
    {
        var shapes = new (string Sql, StreamForge.Engine.TableCompileResult Compile)[]
        {
