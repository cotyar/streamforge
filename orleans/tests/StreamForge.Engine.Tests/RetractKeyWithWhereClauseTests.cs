...
/// row with no "stage" field at all evaluated false/null, and <see cref="StreamForge.Engine.Runtime.Ops.TableFilterProjectOp"/>
/// dropped the retraction before <see cref="StreamForge.Engine.Runtime.Ops.TableLatestByOp"/> ever saw
