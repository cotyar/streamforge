...
/// thrown exception). See shared/StreamForge.Contracts/Models.cs's "Wishlist #8" class doc and
/// shared/StreamForge.AppCore/Generators/ScenarioGenerator.cs's own doc comment for the exact contract
