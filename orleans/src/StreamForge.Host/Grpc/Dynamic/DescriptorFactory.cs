...
using FieldType = StreamForge.Abstractions.FieldType;

namespace StreamForge.Host.Grpc.Dynamic;

/// <summary>
/// A generated dynamic schema: the raw descriptor protobuf StreamForge builds at runtime for one
...
/// <summary>
/// Builds a <see cref="FileDescriptorProto"/> (+ matching .proto text) for one StreamForge entity —
...
{
    public const string PackageName = "streamforge.dynamic.v1";
