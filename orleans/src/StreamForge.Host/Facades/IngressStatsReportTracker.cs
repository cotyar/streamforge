...
/// <see cref="IIngressStatsGrain"/> (<see cref="StreamForge.Host.Services.IngestDrainPumpService"/> is the writer, on
...
/// <see cref="StreamForge.Host.Services.IngestDrainPumpService.ReportStatsAsync"/>).</para>
/// </summary>
