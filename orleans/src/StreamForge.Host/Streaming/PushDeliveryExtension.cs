...
/// streams do today. An extension gets that with ZERO changes to StreamForge.Abstractions — no new grain
/// interface members, no new <c>[Id(n)]</c>s, nothing added to a frozen contract (CLAUDE.md hard rule 1).
/// </summary>
[Alias("StreamForge.Host.Streaming.IPushDeliveryExtension")]
